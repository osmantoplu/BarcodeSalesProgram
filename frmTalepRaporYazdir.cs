...
{
    public partial class frmTalepRaporYazdir : Form
    {
        public frmTalepRaporYazdir()
        {
            InitializeComponent();
        }
        public int SatirSayisi = 0;

        public int Addpage { get; private set; }
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs ffff)
        {
            ...
            try
            {
                frmTalepRapor f = (frmTalepRapor)Application.OpenForms["frmTalepRapor"];
        ...
        private void frmTalepRaporYazdir_Load(object sender, EventArgs e)
        {
