...
{
    public partial class frmFaturaYazdir : Form
    {
        public frmFaturaYazdir()
        {
            InitializeComponent();
        }
        //static int i = 0;
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs ffff)
        {
            ...
            try
            {
                ...
                ffff.Graphics.DrawString("Ürün Adeti", myFont, sbrush, 350, 110); // Detay başlığı
                ffff.Graphics.DrawString("Birim Fiyatı", myFont, sbrush, 600, 110); //Detay başlığı          
        ...
        private void frmFaturaYazdir_Load(object sender, EventArgs e)
        {
            printDocument1.Print();
            this.Close();
