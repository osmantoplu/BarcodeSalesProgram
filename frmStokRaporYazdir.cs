...
{
    public partial class frmStokRaporYazdir : Form
    {
        public frmStokRaporYazdir()
        {
            InitializeComponent();
        }
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs ffff)
        {
            ...
            try
            {
                frmStokRapor f = (frmStokRapor)Application.OpenForms["frmStokRapor"];
                ...
                ffff.Graphics.DrawString("Stok ID", myFont, sbrush, 50, 110); //Detay başlığı
                ffff.Graphics.DrawString("Ürün Adı", myFont, sbrush, 220, 110); //Detay başlığı
                ffff.Graphics.DrawString("Ürün Kodu", myFont, sbrush, 350, 110); // Detay başlığı
                ffff.Graphics.DrawString("Adet", myFont, sbrush, 600, 110); //Detay başlığı          
                ffff.Graphics.DrawString("Kantin Adı", myFont, sbrush, 700, 110); //Detay başlığı
        ...
        private void frmStokRaporYazdir_Load(object sender, EventArgs e)
        {
